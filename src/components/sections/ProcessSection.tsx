          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-16 lg:gap-8">
            {steps.map((step, index) => (
                ...
                >
                  {/* Step Card */}
                  <motion.div
                      className={`relative p-8 rounded-2xl border flex flex-col h-full transition-all duration-500 ease-in-out ${
                          activeStep === index
                  ...
                  >
                    ...
                    <div
                        className="border-t border-gray-700/50 pt-4 mt-auto"
                    >
